...
echo "  SYNC_ENCRYPTION_KEY_FILE=/path/to/sync-tool.key"
echo "  SYNC_ALLOWED_ROOTS=/Users/you:/Volumes/Backup"
echo ""
echo "Production hardening:"
echo "  Set REQUIRE_SECURE_TRANSPORT=true on API/relay when behind HTTPS/WSS proxy."
echo "  Keep ALLOW_LEGACY_WS_QUERY_TOKEN unset or false."
